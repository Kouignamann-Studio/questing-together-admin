...
export const ENEMIES_BY_BIOME: Record<string, BiomeEnemies> = {
  cursed_forest: {
    ...
    bosses: [
      { name: 'Forest Guardian', hpMultiplier: 3, attackMultiplier: 1.5, intro: 'The twisted guardian blocks your path.' },
      { name: 'Spider Queen', hpMultiplier: 2.5, attackMultiplier: 1.8, intro: 'Silk threads descend from above. She is here.' },
    ],
    finalBoss: { name: 'Elder Treant', hpMultiplier: 4, attackMultiplier: 2, intro: 'The ancient tree awakens with a terrible roar.' },
  },
  sunken_sewers: {
    early: [
      { name: 'Rat Geant', hpMultiplier: 0.8, attackMultiplier: 0.7 },
    ...
    bosses: [
      { name: 'Sewer King', hpMultiplier: 3, attackMultiplier: 1.5, intro: 'The lord of filth rises from the muck.' },
    ],
    finalBoss: { name: 'The Abomination', hpMultiplier: 4, attackMultiplier: 2, intro: 'Flesh and metal fused by dark magic.' },
  },
  ruined_fortress: {
    early: [
    ...
    bosses: [
      { name: 'Death Knight', hpMultiplier: 3, attackMultiplier: 1.6, intro: 'A blade of black flame ignites.' },
    ],
    finalBoss: { name: 'Lich Commander', hpMultiplier: 4.5, attackMultiplier: 2.2, intro: 'The dead answer his call.' },
  },
};
